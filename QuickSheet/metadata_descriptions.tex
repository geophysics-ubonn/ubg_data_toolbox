...
Format: One coordinate per line. Either two or three columns, separated by the character ";".
 The first two columns always  are: latitude and longitude.
 An optional third column, "description" can hold identifiers, such as "start", "end", etc.
